...
public class ZipperFormation : Formation {
    ...
    public ZipperFormation() : base(27, FormationType.ZIPPER) {
    ...
    public override void AssignPositions()
    {
        ...
        Positions.Add(new Vector3(-10.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(12.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(-12.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(14.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(-14.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(16.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(-16.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(18.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(-18.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(20.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(-20.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(22.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(-22.0f, 0.0f, 0.0f));
        Positions.Add(new Vector3(24.0f, 0.0f, 2.0f));
        Positions.Add(new Vector3(-24.0f, 0.0f, 2.0f));
